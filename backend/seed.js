...
const seedData = async () => {
    try {
        ...
        // Ensure tables exist (SQLite needs specific initialization)
        ...
        if (services.length === 0) {
            const servicesData = [
                // Cleaning Services
                ['Deep Home Cleaning', 'Thorough cleaning of your entire home including kitchen, bathrooms, bedrooms and living areas. Our professional cleaners use eco-friendly products.', 999, 'Cleaning', '3-4 hrs', 'https://images.unsplash.com/photo-1581578731117-104f2a417954?w=800&auto=format&fit=crop&q=80'],
                ...
                ['Drain Cleaning', 'Professional drain and pipe cleaning service. Removes blockages and prevents future clogs.', 399, 'Plumbing', '1-2 hrs', 'https://images.unsplash.com/photo-1581578731118-b8b8b4f94d0f?w=800&auto=format&fit=crop&q=80'],
            ...
            const imageMap = {
                'Deep Home Cleaning': 'https://images.unsplash.com/photo-1581578731117-104f2a417954?w=800&auto=format&fit=crop&q=80',
                ...
                'Drain Cleaning': 'https://images.unsplash.com/photo-1581578731118-b8b8b4f94d0f?w=800&auto=format&fit=crop&q=80',
